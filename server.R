...
shinyServer(
    function(input, output) {
        ...
        output$plot1 <- renderPlot({
            ...
            g1 <- g1 + geom_histogram(binwidth = .5, fill="pink", color = "black",alpha = .2)
            ...
            g2 <- g2 + geom_histogram(binwidth = .5, fill="pink", color = "black",alpha = .2)
            ...
            g3 <- g3 + geom_histogram(binwidth = .5, fill="green", color = "black",alpha = .2)
            ...
            g4 <- g4 + geom_histogram(binwidth = .5, fill="green", color = "black",alpha = .2)
